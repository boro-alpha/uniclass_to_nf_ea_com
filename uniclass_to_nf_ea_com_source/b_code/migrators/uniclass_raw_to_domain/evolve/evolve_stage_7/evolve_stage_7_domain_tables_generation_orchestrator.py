...
from uniclass_to_nf_ea_com_source.b_code.configurations.common_constants.uniclass_bclearer_constants import EVOLVE_STAGE_7_NAME, \
...
from uniclass_to_nf_ea_com_source.b_code.migrators.uniclass_raw_to_domain.evolve.evolve_stage_7.domain_tables_data_processor.evolve_stage_7_domain_tables_getter import \
...
def orchestrate_domain_tables_creation_for_evolve_7(
    ...
    evolve_stage_7_folder_path = \
        create_new_folder(
            parent_folder_path=folder_path,
            new_folder_name=EVOLVE_STAGE_7_NAME)

    evolve_stage_7_domain_tables_folder_path = \
        create_new_folder(
            parent_folder_path=evolve_stage_7_folder_path,
            new_folder_name=EVOLVE_STAGE_7_NAME + '_domain_tables')
